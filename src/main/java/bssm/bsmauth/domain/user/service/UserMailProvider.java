...
public class UserMailProvider {
    ...
    public void sendAuthCodeMail(String email, String authCode) {
        String content = "<!DOCTYPE HTML>\n" +
                ...
                "                <h2 style=\"display:inline-block;font-size:20px;font-weight:bold;text-align:center;margin:0;color:#e8eaed;padding:15px;border-radius:7px;box-shadow:20px 20px 50px rgba(0, 0, 0, 0.5);background-color:rgba(192, 192, 192, 0.2);\">"+ authCode +"</h2>\n" +
                "                <br><br><br>\n" +
    ...
    public void sendFindIdMail(String email, String id) {
        String content = "<!DOCTYPE HTML>\n" +
                ...
                "                <h2 style=\"display:inline-block;font-size:20px;font-weight:bold;text-align:center;margin:0;color:#e8eaed;padding:15px;border-radius:7px;box-shadow:20px 20px 50px rgba(0, 0, 0, 0.5);background-color:rgba(192, 192, 192, 0.2);\">"+ id +"</h2>\n" +
                "                <br><br><br>\n" +
                "                <div style=\"background-color:rgba(192, 192, 192, 0.2);padding:10px;text-align:left;font-size:14px;\">\n" +
                "                    <p style=\"margin:0;\">- 본 이메일은 발신전용 이메일입니다</p>\n" +
                "                </div><br>\n" +
